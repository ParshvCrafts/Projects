...
# def load_text():
#     with open(r"C:\Users\Parshv\Desktop\Git Hub Projects\wpm_text.txt", "r") as f:
#         lines= f.readlines()
#         return random.choice(lines).strip()

# def wpm_test(stdscr):
#     target_text= load_text()   #load_text()
#     current_text= []
#     wpm=0
...
#         try:  # Does not crash if user does not type
#             key= stdscr.getkey()
#         except:
#             continue
#         if ord(key)== 27: # ASCII representation for escape key
#             break
#         if key in ("KEY_BACKSPACE", "\b", "\x7f"): # If the user enters backspace, remove one character from display
